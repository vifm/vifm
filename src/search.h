...
int find_pattern(view_t *view, const char pattern[], int backward, int move,
...
int goto_search_match(view_t *view, int backward);

/* Auxiliary functions. */

/* Prints results or error message about search operation to the user. */
void print_search_msg(const view_t *view, int backward);

/* Prints error message about failed search to the user. */
void print_search_fail_msg(const view_t *view, int backward);

/* Resets information about last search match. */
void reset_search_results(view_t *view);

/* Prints the search messages for the n or N commands. */
void print_search_next_msg(const view_t *view, int backward);
