 ...
 * should be saved. */
int show_file_menu(view_t *view, int background);

/* Displays menu with list of programs registered for specified file name.
 * Returns non-zero if status bar message should be saved. */
int show_fileprograms_menu(view_t *view, const char fname[]);

/* Displays menu with list of viewers registered for specified file name.
 * Returns non-zero if status bar message should be saved. */
int show_fileviewers_menu(view_t *view, const char fname[]);
