...
void reset_local_options(view_t *view);

/* Loads view-specific settings into corresponding options. */
void load_view_options(view_t *view);
...
void clone_local_options(const view_t *from, view_t *to, int defer_slow);
...
void load_sort_option(view_t *view);

/* Loads current value of dot filter into an option. */
void load_dot_filter_option(const view_t *view);
...
void load_view_columns_option(view_t *view, const char value[]);
