...
static keys_add_info_t builtin_cmds[] = {
	...
	{WK_C_r,           {{&cmd_ctrl_r}}},
	{WK_C_u,           {{&cmd_ctrl_u}}},
	{WK_C_w WK_C_b,    {{&cmd_ctrl_wb}}},
	{WK_C_w WK_H,      {{&cmd_ctrl_wH}}},
	{WK_C_w WK_J,      {{&cmd_ctrl_wJ}}},
	{WK_C_w WK_K,      {{&cmd_ctrl_wK}}},
	{WK_C_w WK_L,      {{&cmd_ctrl_wL}}},
	{WK_C_w WK_b,      {{&cmd_ctrl_wb}}},
	{WK_C_w WK_C_h,    {{&cmd_ctrl_wh}}},
	{WK_C_w WK_h,      {{&cmd_ctrl_wh}}},
	{WK_C_w WK_C_i,    {{&cmd_ctrl_wj}}},
	{WK_C_w WK_j,      {{&cmd_ctrl_wj}}},
	{WK_C_w WK_C_k,    {{&cmd_ctrl_wk}}},
	{WK_C_w WK_k,      {{&cmd_ctrl_wk}}},
	{WK_C_w WK_C_l,    {{&cmd_ctrl_wl}}},
	{WK_C_w WK_l,      {{&cmd_ctrl_wl}}},
	{WK_C_w WK_C_o,    {{&cmd_ctrl_wo}}},
	{WK_C_w WK_o,      {{&cmd_ctrl_wo}}},
	{WK_C_w WK_C_p,    {{&cmd_ctrl_ww}}},
	{WK_C_w WK_p,      {{&cmd_ctrl_ww}}},
	{WK_C_w WK_C_s,    {{&cmd_ctrl_ws}}},
	{WK_C_w WK_s,      {{&cmd_ctrl_ws}}},
	{WK_C_w WK_C_t,    {{&cmd_ctrl_wt}}},
	{WK_C_w WK_t,      {{&cmd_ctrl_wt}}},
	{WK_C_w WK_C_v,    {{&cmd_ctrl_wv}}},
	{WK_C_w WK_v,      {{&cmd_ctrl_wv}}},
	{WK_C_w WK_C_w,    {{&cmd_ctrl_ww}}},
	{WK_C_w WK_w,      {{&cmd_ctrl_ww}}},
	{WK_C_w WK_C_x,    {{&cmd_ctrl_wx}}},
	{WK_C_w WK_x,      {{&cmd_ctrl_wx}}},
	{WK_C_w WK_C_z,    {{&cmd_ctrl_wz}}},
	{WK_C_w WK_z,      {{&cmd_ctrl_wz}}},
	{WK_C_w WK_EQUALS, {{&normal_cmd_ctrl_wequal},   .nim = 1}},
	{WK_C_w WK_LT,     {{&normal_cmd_ctrl_wless},    .nim = 1}},
	{WK_C_w WK_GT,     {{&normal_cmd_ctrl_wgreater}, .nim = 1}},
	{WK_C_w WK_PLUS,   {{&normal_cmd_ctrl_wplus},    .nim = 1}},
	{WK_C_w WK_MINUS,  {{&normal_cmd_ctrl_wminus},   .nim = 1}},
	{WK_C_w WK_BAR,    {{&normal_cmd_ctrl_wpipe},    .nim = 1}},
	{WK_C_w WK_USCORE, {{&normal_cmd_ctrl_wpipe},    .nim = 1}},
	{WK_C_x,           {{&cmd_ctrl_x}}},
	{WK_C_y,           {{&cmd_ctrl_y}}},
	{WK_ESC,           {{&cmd_ctrl_c}}},
	{WK_QUOTE,         {{&cmd_quote}, FOLLOWED_BY_MULTIKEY}},
	{WK_SPACE,         {{&cmd_space}}},
	{WK_EM,            {{&cmd_emark_selector}, FOLLOWED_BY_SELECTOR}},
	{WK_EM WK_EM,      {{&cmd_emarkemark}}},
	{WK_CARET,         {{&cmd_zero}}},
	{WK_DOLLAR,        {{&cmd_dollar}}},
	{WK_PERCENT,       {{&cmd_percent}}},
	{WK_EQUALS,        {{&cmd_equal}}},
	{WK_COMMA,         {{&cmd_comma}}},
	{WK_DOT,           {{&cmd_dot}}},
	{WK_ZERO,          {{&cmd_zero}}},
	{WK_COLON,         {{&cmd_colon}}},
	{WK_SCOLON,        {{&cmd_semicolon}}},
	{WK_SLASH,         {{&cmd_slash}}},
	{WK_QM,            {{&cmd_question}}},
	{WK_C,             {{&cmd_C}}},
	{WK_F,             {{&cmd_F}, FOLLOWED_BY_MULTIKEY}},
	{WK_G,             {{&cmd_G}}},
	{WK_H,             {{&cmd_H}}},
	{WK_L,             {{&cmd_L}}},
	{WK_M,             {{&cmd_M}}},
	...
	{WK_c WK_p,        {{&cmd_cp}}},
	{WK_c WK_w,        {{&cmd_cw}}},
	{WK_D WK_D,        {{&cmd_DD}, .nim = 1}},
	{WK_d WK_d,        {{&cmd_dd}, .nim = 1}},
	{WK_D,             {{&cmd_D_selector}, FOLLOWED_BY_SELECTOR}},
	{WK_d,             {{&cmd_d_selector}, FOLLOWED_BY_SELECTOR}},
	{WK_e,             {{&cmd_e}}},
	{WK_f,             {{&cmd_f}, FOLLOWED_BY_MULTIKEY}},
	{WK_g WK_A,        {{&cmd_gA}}},
	...
	{WK_g WK_j,        {{&cmd_j}}},
	{WK_g WK_k,        {{&cmd_k}}},
	{WK_g WK_l,        {{&cmd_ctrl_m}}},
	{WK_g WK_s,        {{&cmd_gs}}},
	{WK_g WK_U,        {{&cmd_gU}, FOLLOWED_BY_SELECTOR}},
	{WK_g WK_u,        {{&cmd_gu}, FOLLOWED_BY_SELECTOR}},
	{WK_g WK_U WK_U,      {{&cmd_gU}}},
	{WK_g WK_u WK_u,      {{&cmd_gu}}},
	{WK_g WK_U WK_g WK_U, {{&cmd_gU}}},
	{WK_g WK_u WK_g WK_u, {{&cmd_gu}}},
	{WK_g WK_U WK_g WK_g, {{&cmd_gUgg}, .skip_suggestion = 1}},
	{WK_g WK_u WK_g WK_g, {{&cmd_gugg}, .skip_suggestion = 1}},
	{WK_g WK_v,        {{&cmd_gv}}},
	{WK_h,             {{&cmd_h}}},
	{WK_i,             {{&cmd_i}}},
	...
	{WK_k,             {{&cmd_k}}},
	{WK_l,             {{&cmd_l}}},
	{WK_m,             {{&cmd_m}, FOLLOWED_BY_MULTIKEY}},
	{WK_n,             {{&cmd_n}}},
	{WK_p,             {{&cmd_p}}},
	{WK_r WK_l,        {{&cmd_rl}}},
	{WK_q WK_COLON,    {{&cmd_q_colon}}},
	{WK_q WK_SLASH,    {{&cmd_q_slash}}},
	{WK_q WK_QM,       {{&cmd_q_question}}},
	{WK_q WK_EQUALS,   {{&cmd_q_equals}}},
	{WK_t,             {{&cmd_t}}},
	{WK_u,             {{&cmd_u}}},
	{WK_y WK_y,        {{&cmd_yy}, .nim = 1}},
	{WK_y,             {{&cmd_y_selector}, FOLLOWED_BY_SELECTOR}},
	{WK_v,             {{&cmd_V}}},
	{WK_z WK_M,        {{&cmd_zM}}},
	{WK_z WK_O,        {{&cmd_zO}}},
	{WK_z WK_R,        {{&cmd_zR}}},
	{WK_z WK_a,        {{&cmd_za}}},
	{WK_z WK_d,        {{&cmd_zd}}},
	{WK_z WK_b,        {{&normal_cmd_zb}}},
	{WK_z WK_f,        {{&cmd_zf}}},
	{WK_z WK_m,        {{&cmd_zm}}},
	{WK_z WK_o,        {{&cmd_zo}}},
	{WK_z WK_r,        {{&cmd_zr}}},
	{WK_z WK_t,        {{&normal_cmd_zt}}},
	{WK_z WK_z,        {{&normal_cmd_zz}}},
	{WK_LP,            {{&cmd_left_paren}}},
	{WK_RP,            {{&cmd_right_paren}}},
	{WK_LCB,           {{&cmd_left_curly_bracket}}},
	{WK_RCB,           {{&cmd_right_curly_bracket}}},
#ifndef _WIN32
	{WK_c WK_g,        {{&cmd_cg}}},
	{WK_c WK_o,        {{&cmd_co}}},
#else
	...
	{{WC_C_w, KEY_BACKSPACE}, {{&cmd_ctrl_wh}}},
...
static keys_add_info_t selectors[] = {
	{WK_QUOTE,   {{.handler = cmd_quote}, FOLLOWED_BY_MULTIKEY}},
	{WK_PERCENT, {{.handler = cmd_percent}}},
	{WK_CARET,   {{.handler = cmd_zero}}},
	{WK_DOLLAR,  {{.handler = cmd_dollar}}},
	{WK_COMMA,   {{.handler = cmd_comma}}},
	{WK_ZERO,    {{.handler = cmd_zero}}},
	{WK_SCOLON,  {{.handler = cmd_semicolon}}},
	{WK_C_n,     {{.handler = cmd_j}}},
	{WK_C_p,     {{.handler = cmd_k}}},
	{WK_F,       {{.handler = cmd_F}, FOLLOWED_BY_MULTIKEY}},
	{WK_G,       {{.handler = cmd_G}}},
	{WK_H,       {{.handler = cmd_H}}},
	{WK_L,       {{.handler = cmd_L}}},
	{WK_M,       {{.handler = cmd_M}}},
	{WK_S,       {{.handler = selector_S}}},
	{WK_a,       {{.handler = selector_a}}},
	{WK_f,       {{.handler = cmd_f}, FOLLOWED_BY_MULTIKEY}},
	{WK_g WK_g,  {{.handler = cmd_gg}}},
	{WK_h,       {{.handler = cmd_h}}},
	{WK_j,       {{.handler = cmd_j}}},
	{WK_k,       {{.handler = cmd_k}}},
	{WK_l,       {{.handler = cmd_l}}},
	{WK_s,       {{.handler = selector_s}}},
	{WK_LP,      {{.handler = cmd_left_paren}}},
	{WK_RP,      {{.handler = cmd_right_paren}}},
	{WK_LCB,     {{.handler = cmd_left_curly_bracket}}},
	{WK_RCB,     {{.handler = cmd_right_curly_bracket}}},
#ifdef ENABLE_EXTENDED_KEYS
