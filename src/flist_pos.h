...
int find_file_pos_in_list(const view_t *const view, const char file[]);
 ...
 * cases). */
int flist_find_group(const view_t *view, int next);
...
int flist_find_dir_group(const view_t *view, int next);
...
int flist_first_sibling(const view_t *view);
...
int flist_find_by_ch(const view_t *view, int ch, int backward, int wrap);
