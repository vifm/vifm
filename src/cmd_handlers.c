...
const cmd_add_t cmds_list[] = {
  ...
  { .name = "command",          .abbr = "com",   .emark = 1,  .id = COM_COMMAND,     .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 0,
	...
	{ .name = "elseif",           .abbr = "elsei", .emark = 0,  .id = COM_ELSEIF_STMT, .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 1,
	...
	{ .name = "if",               .abbr = NULL,    .emark = 0,  .id = COM_IF_STMT,     .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 1,
	...
	{ .name = "let",              .abbr = NULL,    .emark = 0,  .id = COM_LET,         .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 1,
	...
	{ .name = "set",              .abbr = "se",    .emark = 0,  .id = COM_SET,         .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 1,
		.handler = set_cmd,         .qmark = 0,      .expand = 0, .cust_sep = 0,         .min_args = 0, .max_args = NOT_DEF, .select = 0, },
	{ .name = "setlocal",         .abbr = "setl",  .emark = 0,  .id = COM_SETLOCAL,    .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 1,
		.handler = setlocal_cmd,    .qmark = 0,      .expand = 0, .cust_sep = 0,         .min_args = 0, .max_args = NOT_DEF, .select = 0, },
	{ .name = "setglobal",        .abbr = "setg",  .emark = 0,  .id = COM_SET,         .range = 0,    .bg = 0, .quote = 0, .regexp = 0, .comment = 1,
