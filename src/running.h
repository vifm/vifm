...
int run_with_filetype(view_t *view, const char beginning[], int background);
...
int output_to_custom_flist(view_t *view, const char cmd[], int very,
		int interactive);
