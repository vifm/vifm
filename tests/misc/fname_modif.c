...
test_colon_p(void)
{
	...
	expanded = expand_macros(" cp %f:p ", "", &flags);
	...
	expanded = expand_macros(" cp %d:p ", "", &flags);
...
test_colon_tilde(void)
{
	...
	expanded = expand_macros(" cp %f:~ ", "", &flags);
	...
	expanded = expand_macros(" cp %b:~ ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2 ~" SL "rfile1 ~" SL "rfile3 ~" SL "rfile5 ",
			expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:~ ", "", &flags);
	...
	expanded = expand_macros(" cp %d:~ ", "", &flags);
	assert_string_equal(" cp " SL "lwin ", expanded);
	free(expanded);
...
test_colon_h(void)
{
	...
	expanded = expand_macros(" cp %f:h ", "", &flags);
	assert_string_equal(" cp . . ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %f:p:h ", "", &flags);
	...
	expanded = expand_macros(" cp %b:h ", "", &flags);
	assert_string_equal(" cp . . " SL "rwin " SL "rwin " SL "rwin ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %b:p:h ", "", &flags);
	assert_string_equal(" cp " SL "lwin " SL "lwin " SL "rwin " SL "rwin " SL "rwin ",
			expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:p:h ", "", &flags);
	assert_string_equal(" cp " SL "lwin ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %C:h ", "", &flags);
	assert_string_equal(" cp " SL "rwin ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %d:h ", "", &flags);
	assert_string_equal(" cp " SL " ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %D:h:h ", "", &flags);
	assert_string_equal(" cp " SL " ", expanded);
	free(expanded);
}
...
test_colon_t(void)
{
	...
	expanded = expand_macros(" cp %f:t ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %f:p:t ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2 ", expanded);
	free(expanded);
	...
	expanded = expand_macros(" cp %b:t ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2 rfile1 rfile3 rfile5 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %b:p:t ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2 rfile1 rfile3 rfile5 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:t ", "", &flags);
	assert_string_equal(" cp lfile2 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:p:t ", "", &flags);
	assert_string_equal(" cp lfile2 ", expanded);
	free(expanded);
	...
	expanded = expand_macros(" cp %d:t ", "", &flags);
	assert_string_equal(" cp lwin ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %D:t:t ", "", &flags);
...
test_colon_r(void)
{
	...
	expanded = expand_macros(" cp %c:r ", "", &flags);
	assert_string_equal(" cp lfile2 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:r:r ", "", &flags);
	assert_string_equal(" cp lfile2 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:p:r ", "", &flags);
	assert_string_equal(" cp " SL "lwin" SL "lfile2 ", expanded);
	free(expanded);
	...
	expanded = expand_macros(" cp %C:r:r:r ", "", &flags);
	assert_string_equal(" cp " SL "rw.in" SL "rfile4 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %d:r ", "", &flags);
	assert_string_equal(" cp " SL "lwin ", expanded);
	free(expanded);
...
test_colon_e(void)
{
	...
	expanded = expand_macros(" cp %c:e ", "", &flags);
	assert_string_equal(" cp  ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:e:e ", "", &flags);
	assert_string_equal(" cp  ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %c:p:e ", "", &flags);
	assert_string_equal(" cp  ", expanded);
	free(expanded);
	...
	expanded = expand_macros(" cp %d:e ", "", &flags);
	assert_string_equal(" cp  ", expanded);
	free(expanded);
...
test_colon_s(void)
{
	...
	expanded = expand_macros(" cp %f:s?l?r ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2", expanded);
	free(expanded);
	...
	expanded = expand_macros(" cp %f:salara ", "", &flags);
	assert_string_equal(" cp rfile0 rfile2 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %f:s?l?r?k? ", "", &flags);
	assert_string_equal(" cp rfile0 rfile2k? ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %f:s?l?r?:s!f!k!k? ", "", &flags);
...
test_colon_gs(void)
{
	...
	expanded = expand_macros(" cp %f:gs?l?r ", "", &flags);
	assert_string_equal(" cp lfile0 lfile2", expanded);
	free(expanded);
	...
	expanded = expand_macros(" cp %f:gsalara ", "", &flags);
	assert_string_equal(" cp rfire0 rfire2 ", expanded);
	free(expanded);

	expanded = expand_macros(" cp %f:gs?l?r?k? ", "", &flags);
...
#ifdef _WIN32
	{
		...
		expanded = expand_macros(" cp %f:p:gs?\\?/? ", "", &flags);
...
test_windows_specific(void)
{
	...
	expanded = expand_macros(" %d:h ", "", &flags);
	assert_string_equal(" h:\\\\ ", expanded);
	free(expanded);

	expanded = expand_macros(" %d:h:h ", "", &flags);
	assert_string_equal(" h:\\\\ ", expanded);
	free(expanded);
...
test_modif_without_macros(void)
{
	...
	expanded = expand_macros(" cp %f:t :p :~ :. :h :t :r :e :s :gs ", "",
			&flags);
