...
TEST(one_console_prog)
{
	...
	assoc_programs("*.tar", "x prog", 1, 0);
	assoc_programs("*.tar", "console prog", 0, 0);
...
TEST(one_graphic_prog)
{
	...
	assoc_programs("*.tar", "x prog", 1, 1);
	assoc_programs("*.tar", "console prog", 0, 1);
...
{
	assoc_programs("*.tgz", "2 x prog", 1, 0);
...
TEST(two_graphic_prog)
{
	...
	assoc_programs("*.tgz", "2 x prog", 1, 1);
...
TEST(three_console_prog)
{
	...
	assoc_programs("*.tar.bz2", "3 console prog", 0, 1);
...
TEST(three_graphic_prog)
{
	...
	assoc_programs("*.tar.bz2", "3 console prog", 0, 0);
